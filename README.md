...
Welcome to the **VHDL-Based Pong Game** project! This repository contains a complete hardware implementation of the classic Pong game, designed specifically for the **Altera Cyclone V GX FPGA**. Let's have a quick Demo of the Game in video below.  
