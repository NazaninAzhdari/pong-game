...
architecture RTL of gameOver_melody_gen is
    ...
    signal tone_indx            : integer range 0 to 4                :=0;

    type t_tone is array (0 to 4) of integer;
    constant c_HALF_PERIOD_TONE : t_tone :=(
        0 => 24,
        1 => 34,
        2 => 48,
        3 => 96,
                ...
                if rising_edge(i_clk) then
                    ...
                    if i_LRCLK = '1' and r_LRCLK = '0' then --rising-edge of LRCLK
                        if i_en = '1' then
                            ...
                            if r_freq_counter < c_HALF_PERIOD_TONE(tone_indx)-1 then
